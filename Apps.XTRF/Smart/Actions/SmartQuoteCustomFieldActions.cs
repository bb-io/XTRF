...
public class SmartQuoteCustomFieldActions : BaseSmartCustomFieldActions
{
    ...
    public async Task<SmartCustomFieldIdentifier> UpdateTextCustomFieldForQuote(
        [ActionParameter] QuoteIdentifier quoteIdentifier,
        [ActionParameter] SmartCustomFieldIdentifier customFieldIdentifier,
    ...
    public async Task<SmartCustomFieldIdentifier> UpdateNumberCustomFieldForQuote(
        [ActionParameter] QuoteIdentifier quoteIdentifier,
        [ActionParameter] SmartCustomFieldIdentifier customFieldIdentifier,
    ...
    public async Task<SmartCustomFieldIdentifier> UpdateDateCustomFieldForQuote(
        [ActionParameter] QuoteIdentifier quoteIdentifier,
        [ActionParameter] SmartCustomFieldIdentifier customFieldIdentifier,
    ...
    public async Task<SmartCustomFieldIdentifier> UpdateCheckboxCustomFieldForQuote(
        [ActionParameter] QuoteIdentifier quoteIdentifier,
        [ActionParameter] SmartCustomFieldIdentifier customFieldIdentifier,
    ...
    public async Task<SmartCustomFieldIdentifier> UpdateMultipleSelectionCustomFieldForQuote(
        [ActionParameter] QuoteIdentifier quoteIdentifier,
        [ActionParameter] SmartCustomFieldIdentifier customFieldIdentifier,
